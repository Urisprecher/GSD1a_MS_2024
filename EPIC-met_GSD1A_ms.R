...
rgSet_data
###proc+qc
### in addition to Genome_Studio QC and BACR 
##outlier samples?
...
#Generate the table of results for the contrast with annotation
...
# Function to remove characters after "_"- adjust data to EPICV2 structure
remove_after_underscore <- function(text) {
  gsub("_.*", "", text)
}
# apply on the original column to create modified column for EPIVv2
